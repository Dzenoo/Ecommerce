...
import { GetProductsDto } from '@shared/types';
import { getCategory } from '@shared/lib/utils';
import {
  ProductQueryType,
  useProductQuery,
} from '@shared/hooks/queries/useProduct.query';
import { useQueryParams } from '@shared/hooks/core/useQueryParams';
...
import PaginateList from '@shared/components/ui/pagination/paginate-list';
import FilterProducts from '@/components/root/products/filters/FilterProducts';
import LoadingProducts from '@shared/components/shared/loading/products/LoadingProducts';
