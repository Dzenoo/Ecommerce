...
import { Category, IProduct } from '@shared/types';
import { CATEGORY_LIST } from '@shared/constants';
import {
  CreateProductSchema,
  UpdateProductSchema,
} from '@shared/lib/zod/product.zod';
import { getCategory } from '@shared/lib/utils';
import { useToast } from '@shared/hooks/core/use-toast';
import { validateObject } from '@shared/validations/validate-object';
import {
  useProductMutation,
  ProductMutationType,
...
import FormFieldRenderer from '@shared/helpers/FormFieldRenderer';
import Uploader from '@shared/components/shared/Uploader';
